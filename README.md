...
[![Format: Markdown](https://img.shields.io/badge/format-markdown-blue.svg)](https://github.com/cameronww7/Notes)
[![PRs: Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/cameronww7/Notes)
...
```
Notes/
├── Security/              threat modeling library, checklists, tooling landscape
├── AI/                    Claude workflows, token efficiency
├── Terms & Definitions/   glossaries and reference material
├── Career/                pathways, leveling, and career mapping
...
- **Threat Modeling**: system design + threat model write-ups, each covering architecture, trust boundaries, DFDs, and a threat table:
  ...
  - Worked examples:
    - [Password Manager](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/Password%20Manager%20-%20Architecture%20and%20Threat%20Model.md)
    - [P2P Payment App](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/P2P%20Payment%20App%20-%20Design%20and%20Threat%20Model.md)
    - [Cloud File Storage Service](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/Cloud%20File%20Storage%20Service%20-%20Design%20and%20Threat%20Model.md)
    - [Multi-Tenant SaaS Isolation Model](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/Multi-Tenant%20SaaS%20Architecture%20-%20Isolation%20Model.md)
    - [Three-Tier Architecture](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/Three-Tier%20Architecture%20-%20System%20Design%20%2B%20Threat%20Model.md)
    - [GitLab-Style SaaS (Multi-Tier)](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/System%20Design%20%2B%20Threat%20Model%20-%20GitLab-Style%20Commercial%20SaaS%20-%20%283%2C4%2C5%20Tier%20System%29.md)
    - [Threat Modeling a Local AI Box (Mac Studio Edition)](Security/Threat%20Modeling/0%20-%20Threat%20Models%20Examples/Threat%20Modeling%20a%20Local%20AI%20Box%20%28Mac%20Studio%20Edition%29.md)
...
### Career
- [The Cybersecurity Career Map](Career/The%20Cybersecurity%20Career%20Map.md): real job titles across security, what they actually do, how hard each is to break into, and how many of them exist.
